...
enemy_spells = [fire, meteor, cure, cura, curaga]
enemy_spells2 = [fire, meteor, cure]
...
enemy1 = Person("Imp  ", 1250, 130, 560, 325, enemy_spells2, [])
enemy2 = Person("Magus", 18200, 701, 525, 25, enemy_spells, [])
enemy3 = Person("Imp  ", 1250, 130, 560, 325, enemy_spells2, [])
...
while running:
    ...
    for enemy in enemies:
        ...
        if enemy_choice == 0:
            ...
            if enemy == enemy2:
                if enemy.get_hp() < enemy.get_hp() - 7000:
                    spell, magic_dmg = enemy.choose_enemy_spell()

                else:
                    spell, magic_dmg = enemy.choose_enemy_spell2()
